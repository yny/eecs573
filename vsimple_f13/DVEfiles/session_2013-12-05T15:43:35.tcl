...
# DVE full session
# Saved on Thu Dec 5 15:43:35 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{700 159} {1818 1270}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 230} {height 883} {dock_state left} {dock_on_new_line true} {child_hier_colhier 187} {child_hier_coltype 76} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 447} {height 883} {dock_state left} {dock_on_new_line true} {child_data_colvariable 222} {child_data_colvalue 152} {child_data_coltype 72} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 105]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1119
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 105
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1118} {height 105} {dock_state bottom} {dock_on_new_line true}}
